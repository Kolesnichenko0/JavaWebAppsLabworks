...
class TrainTest {
    ...
    class StationNameValidation {
        ...
        void testValidStationNames(String station) {
            assertDoesNotThrow(() -> Train.validateStationName(station, TrainFieldName.DEPARTURE_STATION),
        ...
        void testInvalidStationNames(String station) {
            Exception exception = assertThrows(IllegalArgumentException.class,
                    () -> Train.validateStationName(station, TrainFieldName.DEPARTURE_STATION));
        ...
        void testAutoCorrectStationNames(String input, String expected) {
            String result = Train.validateStationName(input, TrainFieldName.DEPARTURE_STATION);
